\section{Softwareoptionen}
    ...
    \begin{frame}{Spezielle Statistiksoftware}
        \begin{itemize}
            ...
            \item \includegraphics[height=\baselineskip]{images/Rlogo.png} scheint sich in den letzten Jahren an den Hochschulen immer mehr durchzusetzen. Seit 2019 gibt es im VDSt die Kosis-Gemeinschaft ``Ko-R'', die zum Ziel hat, \includegraphics[height=\baselineskip]{images/Rlogo.png} als gemeinsame Entwicklungs- und Anwendungssprache zu etablieren.
            \item SAS
            \item Stata
            \item Statistica
        \end{itemize}
    ...
    \begin{frame}{Kosis-Software}
        \begin{description}
            ...
            \item[KO.R] Analyse- und Auswertungstools mit \includegraphics[height=\baselineskip]{images/Rlogo.png}
        \end{description}
    \end{frame}
    \begin{frame}{HHSTAT}
