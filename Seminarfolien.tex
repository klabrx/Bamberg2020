...
\setbeamertemplate{frame footer}{Grunlagen der Kommunalstatistk - Bamberg, Herbst 2020}
...
\begin{frame}{Datenschutz}
	...
	\end{block}
      ...
      \begin{exampleblock}{Einwilligung}
        \begin{itemize}
            \item Informiert (Was beinhaltet die Einwilligung?)
            \item Dokumentiert (Nachweis der Einwilligung muss möglich sein)
            \item Reglementiert (Wie komme ich aus der Nummer wieder raus?)
        \end{itemize}
      \end{exampleblock}	
\end{frame}
