...
\begin{frame}[allowframebreaks]{Räumliche Gliederung}
    \begin{exampleblock}{``Alles, was passiert, passiert irgendwo.''}
        Räumliche Gliederungssysteme erlauben die Zuordnung von Beobachtungen, Ereignissen, Erhebungsergebnissen zu geografischen Einheiten. Drei Gliederungssysteme sind in der Kommunalstatistik besonders relevant:
    \end{exampleblock}
    \begin{exampleblock}{Nationalitätenschlüssel}
        \dots steht für eine rechtliche Staatsangehörigkeit, ersatzweise auch für den Migrationshintergrund. Dieser 3-stellige sog. "BEV-Code" wird von statistischen Bundesamt (destatis) regelmäßig aktualisiert und veröffentlicht.
    \end{exampleblock}
    \begin{exampleblock}{Allgemeiner Gebietsschlüssel}
        \dots bezeichnet die Zugehörigkeit zu einer Gemeinde. Der hierarchische Aufbau erlaubt auch die Zuordnung einer Gemeinde (am Beispiel Bayern) zum Kreis, Bezirk und Bundesland.
    \end{exampleblock}
    \begin{exampleblock}{Kleinräumige Gliederung}
        \dots steht für eine untergemeindliche Gebietseinteilung und Stadtteile, Bezirke, Distrikte, Blöcke, \dots sowie die daraus gebildeten sachlichen Gebietseinheiten (Schulsprengel, Stimmbezirke,  Einzugsbereiche, Sanierungsgebiete, \dots)
    \end{exampleblock}
...
\begin{frame}{Hierarchischer Aufbau}
    \begin{block}{Das Gebiet der Stadt Passau (AGS 09262000) besteht aus \dots}
        \begin{description}
            \item[5 Prognoseräumen:] Erste Stelle der KRG (1-5), bestehend aus
            \item[16 Stadtteilen:] Erste zwei Stellen der KRG (11-52), bestehend aus
            \item[Blöcken:] Erste fünf Stellen der KRG (11001-52035), bestehend aus
            \item[Blockseiten:] Alle 7 Stellen der KRG
        \end{description}
    \end{block}
...
\begin{frame}{Zuordnung von Gebietseinteilungen}
    ...
    \end{alertblock}
\end{frame}
\begin{frame}{Rudimentärversion einer KlGl}
    \begin{table}[]
        \centering
        \begin{tabular}{llllll}
             \textbf{StrID} & \textbf{HsNr} & \textbf{Zusatz} & \textbf{KlGl} & \textbf{Gebiet 1} & \textbf{Gebiet 2} \\
             12345 & 0001 & C & 1207233 & 01 (Stadtmitte) & \dots \\
             12345 & 0001 & D & 1207233 & 01 (Stadtmitte) & \dots \\
             12345 & 0002 &   & 1207234 & 01 (Stadtmitte) & \dots \\
             12345 & 0003 &   & 1207233 & 01 (Stadtmitte) & \dots \\
             12345 & 0004 &   & 1207234 & 01 (Stadtmitte) & \dots \\
             & 
        \end{tabular}
    \end{table}
    In Textformat:
    \newline
    \texttt{123450001C 120723301\dots} \newline
    \texttt{123450001D 120723301\dots} \newline
    \texttt{123450002  120723301\dots} \newline
    \texttt{123450003  120723301\dots} \newline
    \texttt{123450004  120723301\dots}
\end{frame}